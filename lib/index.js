...
var _convertCode = function convertCode(code, label, type) {
  var htmlStr = "<div class=\"start\">".concat(label ? '<span class="label">"' + label + '":</span>' : '').concat(type === 'array' ? '[' : '{', "</div>");
  try {
    ...
    Object.keys(obj).forEach(function (key) {
      if (_typeof(obj[key]) === 'object') {
        ...
        htmlStr += "\n        <div class=\"option\">\n          <div class=\"label\">\"".concat(key, "\": </div>\n          <div class=\"value ").concat(_typeof(obj[key]), "\">").concat(typeof obj[key] !== 'string' ? obj[key] : JSON.stringify(obj[key]), "</div>\n        </div>\n      ");
      }
    });
          ...
          case '@apiSuccessExample':
            {
              ...
              obj.successExample = _convertCode(example[1]);
            }
            break;
          case '@apiFailExample':
            {
              var _example = item.split('Fail-Response:');
              obj.failExample = _convertCode(_example[1]);
            }
            break;
          case '@apiCode':
            {
